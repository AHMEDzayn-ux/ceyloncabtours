          ...
          <ScrollReveal delay={0.1}>
            <div className="max-w-md mx-auto text-center">
              <a
                ...
                className="inline-flex items-center gap-3 bg-emerald-500 hover:bg-emerald-600 text-white px-8 py-4 rounded-xl font-semibold text-lg shadow-lg hover:shadow-xl transition-all duration-300 hover:scale-105"
              >
                <svg
                  className="w-7 h-7"
                  fill="currentColor"
